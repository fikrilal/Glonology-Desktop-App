...
public class BingkaiGambar extends JComponent {
    ...
    private Color gradientColor1 = new Color(130, 130, 130);
    private Color gradientColor2 = new Color(130, 130, 130);
    ...
    private void createBorder(Graphics2D g2) {
        ...
        Area area = new Area(new RoundRectangle2D.Double(x, y, diameter, diameter, 15, 15));
        int s = diameter -= (borderSize * 2);
        area.subtract(new Area(new Rectangle2D.Double(x + borderSize, y + borderSize, s, s)));
